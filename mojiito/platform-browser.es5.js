...
var DomVisitor = (function () {
    ...
    DomVisitor.prototype.visitElement = function (element, context) {
        ...
        var /** @type {?} */ view = createView(context.root, context, element, viewDef);
...
var Compiler = (function () {
    ...
    Compiler.prototype.compileComponent = function (component) {
        ...
        var /** @type {?} */ componentFactory = createComponentFactory(metadata.selector, component, viewDefinitionFactory);
        compileSummary = {
            type: component,
    ...
    Compiler.prototype._createProviderNodes = function (providers, nodes, nodeType) {
        var /** @type {?} */ nodeDefs = resolveReflectiveProviders(ListWrapper.flatten(providers))
...
var BrowserPlatformRef = (function (_super) {
    ...
    BrowserPlatformRef.prototype.bootstrapComponent = function (component) {
        ...
        var /** @type {?} */ appInjector = ReflectiveInjector.resolveAndCreate([
            {
        ...
        var /** @type {?} */ app = (appInjector.get(ApplicationRef));
...
var platformBrowser = createPlatformFactory([PLATFORM_PROVIDERS, CORE_PROVIDERS]);
/**
 * @module
 * @description
